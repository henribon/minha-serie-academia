...
const USERS_CONFIG = {
    ...
    mari: {
        ...
        // Per-exercise weight tracking (kg field shown under each exercise)
        weightTracking: true,

        // Workout Days
        workoutDays: [
            {
                title: 'Treino - Perna & Glúteo',
                emoji: '🍑',
                exercises: [
                    { name: 'Agachamento Búlgaro', reps: '3x8', gif: 'https://image.tuasaude.com/media/article/dv/bw/agachamento-bulgaro_62764.gif?width=686&height=487' },
                    { name: 'Good Morning (Barra)', reps: '3x12', gif: 'https://www.meridian-fitness.co.uk/wp-content/uploads/2024/12/GoodMorning_2-ezgif.com-optimize-1.gif' },
                    { name: 'Cadeira Abdutora (Máquina)', reps: '3x12', gif: 'https://www.mundoboaforma.com.br/wp-content/uploads/2021/04/pernas-aducao-de-pernas-na-maquina.gif' },
                    { name: 'Elevação Pélvica (Barra)', reps: '4x10', gif: 'https://treinoemalta.com.br/wp-content/uploads/2023/07/Elevacao-Pelvica.gif' },
                    { name: 'Levantamento Terra (Barra)', reps: '4x10', gif: 'https://www.hipertrofia.org/blog/wp-content/uploads/2017/11/barbell-deadlift.gif' },
                    { name: 'Elevação de Panturrilha (Máquina)', reps: '4x20', gif: 'https://www.hipertrofia.org/blog/wp-content/uploads/2023/03/lever-standing-calf-raise.gif' },
                    { name: 'Pontapés Traseiros Com Elástico', reps: '3x10', gif: 'https://www.hipertrofia.org/blog/wp-content/uploads/2024/06/coice.gif' }
                ]
            }
        ]
    }
